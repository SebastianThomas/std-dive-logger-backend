...
public class UsersController {
    ...
    @GetMapping("/")
    public FrontendUser loggedInUser(@AuthenticationPrincipal final @Nullable User user) {
        if (user == null) {
    ...
    @DeleteMapping("/icon")
    public FrontendUser resetIcon(@AuthenticationPrincipal final @Nullable User user) {
        if (user == null) {
