 ...
 * services return this from their {@code parseOne(...)}-style methods; {@link ImportService}
 * turns it into a {@code PendingImportEntity} row (stage) and, later, into a real {@code Dive}
 * (commit).
 */
